{{-- 
    TEMPLATE DASAR CRUD - PARTIAL MODAL CREATE
    Gunakan komponen <x-modal-form> agar tampilan konsisten (rounded-2xl, backdrop-blur, tombol standar).
--}}

<x-modal-form show="isCreateOpen" 
              title="Tambah Data Baru" 
              maxWidth="max-w-[340px]"
              action="`{{ route('program.master.template-crud.store') }}`" 
              method="POST" 
