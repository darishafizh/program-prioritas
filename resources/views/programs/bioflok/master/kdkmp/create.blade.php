<!-- Offcanvas Full-Screen Form Create -->
<div x-show="isCreateOpen" style="display: none; z-index: 99999;" class="fixed inset-0 overflow-hidden">
    <!-- Latar Belakang Gelap (Backdrop) -->
    <div x-show="isCreateOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
        x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-200"
        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click="isCreateOpen = false"
        class="fixed inset-0 bg-black/60 backdrop-blur-sm transition-opacity">
    </div>

    <!-- Panel Offcanvas (Full Screen bergeser dari Kanan) -->
    <div class="fixed inset-0 w-full flex">
        <div x-show="isCreateOpen" @click.away="isCreateOpen = false"
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-textMain-light dark:text-textMain-dark">Tambah Data Master
                            KDKMP</h3>
                        <p class="text-xs text-textMuted-light mt-0.5">Formulir lengkap penambahan referensi Kelompok
                            Pembudidaya Ikan (KDKMP).</p>
                    </div>
                </div>
                <button @click="isCreateOpen = false"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" x-model="formData.provinsi" list="create-provinsi-list"
                                            placeholder="Contoh: DI. Yogyakarta"
                                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-sm outline-none focus:border-teal-light focus:ring-1 focus:ring-teal-light transition-all text-textMain-light dark:text-textMain-dark">
                                        <datalist id="create-provinsi-list">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" x-model="formData.kabupaten" list="create-kabupaten-list"
                                            placeholder="Contoh: Bantul"
                                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-sm outline-none focus:border-teal-light focus:ring-1 focus:ring-teal-light transition-all text-textMain-light dark:text-textMain-dark">
                                        <datalist id="create-kabupaten-list">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" x-model="formData.komoditas" list="create-komoditas-list"
                                            placeholder="Contoh: Nila / Lele / Udang"
                                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-sm outline-none focus:border-teal-light focus:ring-1 focus:ring-teal-light transition-all text-textMain-light dark:text-textMain-dark">
                                        <datalist id="create-komoditas-list">
