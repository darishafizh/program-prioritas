...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="flex flex-wrap items-center gap-3">
        <button class="bg-gradient-to-r from-warning to-amber-600 hover:from-amber-600 hover:to-warning text-white rounded-md px-4 py-2 text-xs font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-between gap-2"> Tambah {{ ucfirst($type) }} <i class="fa-solid fa-plus"></i> </button>
    </div>
</div>
...
<div class="bg-bgSurface-light dark:bg-bgSurface-dark border border-gray-100 dark:border-gray-800 rounded-3xl shadow-sm overflow-hidden flex flex-col">
    ...
    <div class="p-4 border-b border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50/50 dark:bg-gray-800/20">
        <div class="flex items-center gap-2 text-sm text-textMuted-light dark:text-textMuted-dark">
            <span>Tampilkan</span>
            <select class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:border-warning text-textMain-light dark:text-textMain-dark font-medium shadow-sm">
                <option>10</option>
                <option>25</option>
                <option>50</option>
            </select>
        ...
        <div class="relative w-full sm:w-64">
            ...
            <input type="text" placeholder="Cari {{ $type }}..." class="w-full pl-9 pr-4 py-2 rounded-xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm focus:border-warning focus:ring-1 focus:ring-warning outline-none transition-all shadow-sm">
        </div>
    </div>
