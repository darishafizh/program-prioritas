...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="relative flex items-center bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-xl px-4 py-2 text-sm font-medium shadow-sm focus-within:ring-2 focus-within:ring-warning focus-within:border-warning">
...
<div class="mb-6 relative overflow-hidden rounded-3xl bg-gradient-to-br from-bgSurface-light to-orange-50 dark:from-bgSurface-dark dark:to-orange-900/10 border border-warning/20 shadow-sm p-6 sm:p-8">
    ...
    <div class="relative z-10 max-w-4xl">
        <div class="flex items-center gap-2 text-warning dark:text-amber-500 font-medium text-sm tracking-widest uppercase mb-3">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
    <div class="bg-bgSurface-light dark:bg-bgSurface-dark border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm relative overflow-hidden group">
        ...
        <div class="flex items-center gap-4 mb-4 relative z-10">
            <div class="w-12 h-12 rounded-xl bg-success/10 flex items-center justify-center text-success text-base">
                <i class="fa-solid fa-draw-polygon"></i>
            </div>
            <div>
                <h3 class="text-sm font-medium text-textMuted-light dark:text-textMuted-dark uppercase tracking-wider">Total Petak</h3>
                <div class="text-base font-medium">45</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-bgSurface-light dark:bg-bgSurface-dark border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm relative overflow-hidden group">
        ...
        <div class="flex items-center gap-4 mb-4 relative z-10">
            <div class="w-12 h-12 rounded-xl bg-teal-light/10 flex items-center justify-center text-teal-light text-base">
                <i class="fa-solid fa-water"></i>
            </div>
            <div>
                <h3 class="text-sm font-medium text-textMuted-light dark:text-textMuted-dark uppercase tracking-wider">Total Kolam</h3>
                <div class="text-base font-medium">120</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-bgSurface-light dark:bg-bgSurface-dark border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm relative overflow-hidden group">
        ...
        <div class="flex items-center gap-4 mb-4 relative z-10">
            <div class="w-12 h-12 rounded-xl bg-warning/10 flex items-center justify-center text-warning text-base">
                <i class="fa-solid fa-boxes-stacked"></i>
            </div>
            <div>
                <h3 class="text-sm font-medium text-textMuted-light dark:text-textMuted-dark uppercase tracking-wider">Total Produksi</h3>
                <div class="text-base font-medium">8,450 <span class="text-sm text-textMuted-light font-medium">Ton</span></div>
            </div>
        </div>
    </div>
</div>
...
<!-- Chart Section -->
<div class="bg-bgSurface-light dark:bg-bgSurface-dark border border-gray-100 dark:border-gray-800 rounded-3xl shadow-sm p-6 flex flex-col items-center justify-center min-h-[300px]">
    <i class="fa-solid fa-chart-line text-6xl text-gray-200 dark:text-gray-700 mb-4"></i>
    <h3 class="text-base font-medium text-gray-400 dark:text-gray-500">Grafik Produksi Dimuat Disini</h3>
