        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div
                ...
                <div class="flex items-center gap-4 mb-3 relative z-10">
                    <div class="w-12 h-12 rounded-xl bg-warning/10 flex items-center justify-center text-warning text-sm"><i
                            class="fa-solid fa-person-digging"></i></div>
                    <div>
                        <h3
                            class="text-xs font-medium text-textMuted-light dark:text-textMuted-dark uppercase tracking-wider">
                            Konstruksi Aktif</h3>
                        <div class="text-sm font-medium text-warning">{{ $stats['konstruksi_aktif'] }} <span
            ...
            <div
                ...
                <div class="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2 relative z-10 mt-2">
                    <div class="bg-teal-light h-2 rounded-full transition-all" style="width: {{ $stats['rata_progres'] }}%">
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center gap-4 mb-3 relative z-10">
                    ...
                    <div>
                        <h3
                            class="text-xs font-medium text-textMuted-light dark:text-textMuted-dark uppercase tracking-wider">
                            Serah Terima</h3>
                        <div class="text-sm font-medium text-success">{{ $stats['total_selesai'] }} <span
                                class="text-sm font-medium text-textMuted-light">Lokasi</span></div>
                    </div>
                </div>
            </div>
            ...
            <div
                class="bg-bgSurface-light dark:bg-bgSurface-dark border border-gray-100 dark:border-gray-800 rounded-3xl p-6 relative overflow-hidden group">
                <div
                    class="absolute top-0 right-0 w-32 h-32 {{ $stats['rata_deviasi'] >= 0 ? 'bg-success/10' : 'bg-danger/10' }} rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-110">
                </div>
                <div class="flex items-center gap-4 mb-3 relative z-10">
                    <div
                        class="w-12 h-12 rounded-xl {{ $stats['rata_deviasi'] >= 0 ? 'bg-success/10' : 'bg-danger/10' }} flex items-center justify-center {{ $stats['rata_deviasi'] >= 0 ? 'text-success' : 'text-danger' }} text-sm">
                        <i
                            class="fa-solid {{ $stats['rata_deviasi'] >= 0 ? 'fa-arrow-trend-up' : 'fa-arrow-trend-down' }}"></i>
                    </div>
                    <div>
                        <h3
                            class="text-xs font-medium text-textMuted-light dark:text-textMuted-dark uppercase tracking-wider">
                            Rata-Rata Deviasi</h3>
                        <div
                            class="text-sm font-medium {{ $stats['rata_deviasi'] >= 0 ? 'text-success' : 'text-danger' }}">
