                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800 bg-white dark:bg-bgSurface-dark">
                        <template x-for="(item, index) in paginatedData()" :key="index">
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                <td class="px-6 py-4">
                                    <span class="font-medium text-teal-light hover:underline cursor-pointer"
                                        x-text="item.idUser"></span>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-2.5 py-1 rounded-md text-[0.7rem] font-medium"
                                        :class="{
                                            'bg-teal-light/10 text-teal-light': ['verif_admin', 'ba_aktivasi',
                                                'verif_teknis', 'ba_calon'
                                            ].includes(item.status_tahapan),
                                            'bg-success/10 text-success': item.status_tahapan === 'penetapan',
                                            'bg-danger/10 text-danger': item.status_tahapan === 'ditolak',
                                        }"
                                        :style="item.status_tahapan === 'pengajuan' ?
                        ...
                        <tr x-show="paginatedData().length === 0">
                            <td colspan="6" class="px-6 py-8 text-center text-textMuted-light">Belum ada data calon
                                lokasi atau tidak ada hasil pencarian.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
