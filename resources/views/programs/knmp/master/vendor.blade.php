...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    ...
    <div class="flex items-center gap-3">
        <button class="bg-gradient-to-r from-info to-blue-600 hover:from-blue-600 hover:to-info text-white rounded-md px-4 py-2 text-xs font-medium shadow-md transition-all flex items-center justify-between gap-2"> Register Vendor Baru <i class="fa-solid fa-user-plus"></i> </button>
    </div>
</div>
